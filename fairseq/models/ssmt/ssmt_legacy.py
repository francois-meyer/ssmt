...
from fairseq.models.ssmt.ssmt_config import (
    SubwordSegmentalConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fairseq.models.ssmt.ssmt_base import (
    SubwordSegmentalModelBase,
)


@register_model("ssmt")
class SubwordSegmentalModel(SubwordSegmentalModelBase):
    """
    ...
    def __init__(self, args, encoder, decoder):
        cfg = SubwordSegmentalConfig.from_namespace(args)
    ...
    def add_args(cls, parser):
        ...
        gen_parser_from_dataclass(
            parser, SubwordSegmentalConfig(), delete_default=True, with_prefix=""
        )
    ...
    def build_embedding(cls, args, dictionary, embed_dim, path=None):
        return super().build_embedding(
            SubwordSegmentalConfig.from_namespace(args), dictionary, embed_dim, path
        )

    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return super().build_encoder(
            SubwordSegmentalConfig.from_namespace(args), src_dict, embed_tokens
        )

    @classmethod
    def build_decoder(cls, args, tgt_dict, tgt_lex, embed_tokens):
        return super().build_decoder(
            SubwordSegmentalConfig.from_namespace(args), tgt_dict, tgt_lex, embed_tokens
        )


@register_model_architecture("ssmt", "ssmt")
